...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            SingletonSimple.deserialiserListe(applicationContext)
        } catch (e: Exception) {
            Toast.makeText(this, "Bienvenue, il s'agit de votre première utilisation", Toast.LENGTH_LONG).show()
        }
    }
    //3e étape
